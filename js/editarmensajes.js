...
function editarRegistro(llaveRegistro) {
    ...
    $.ajax({
        ...
        url: "https://g7ac2c4aa75e0db-proyecto16.adb.sa-saopaulo-1.oraclecloudapps.com/ords/admin/message/message" + llaveRegistro,
...
function actualizar() {
    ...
    if (validarEditar()) {
        $.ajax({
            // la URL para la petición (url: "url al recurso o endpoint")
            url: "https://g7ac2c4aa75e0db-proyecto16.adb.sa-saopaulo-1.oraclecloudapps.com/ords/admin/message/message",
