...
function editarRegistro(llaveRegistro) {
    ...
    $.ajax({
        ...
        url: "https://g7ac2c4aa75e0db-proyecto16.adb.sa-saopaulo-1.oraclecloudapps.com/ords/admin/partyroom/partyroom" + llaveRegistro,
...
function editarRespuesta(items) {
    ...
    $("#ownerEdit").val(items[0].owner);
    $("#capacityEdit").val(items[0].capacity);
    $("#category_idEdit").val(items[0].category_id);    
}
...
function actualizar() {
    ...
    let datos = {
        ...
        category_id: $("#category_idEdit").val(),
        name: $("#nameEdit").val()
    }
    ...
    if (validarEditar()) {
        $.ajax({
            // la URL para la petición (url: "url al recurso o endpoint")
            url: "https://g7ac2c4aa75e0db-proyecto16.adb.sa-saopaulo-1.oraclecloudapps.com/ords/admin/partyroom/partyroom",
